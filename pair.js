...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'shahzaibilyas765@gmail.com', // Your Mega A/c Email Here
            password: '03007812516M' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'BAJWA-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of BAJWA-MD.
...
🚀 _Thanks for choosing BAJWA-MD — Let the automation begin!_ ✨`;
